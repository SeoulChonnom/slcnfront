...
import type { RawShoesCatalog } from '../types';

export const rawGlobalShoes: RawShoesCatalog = {
  brands: [
    {
      id: 1,
      brandId: 'nb',
...
export const globalShoes = normalizeShoesCatalog(rawGlobalShoes);
